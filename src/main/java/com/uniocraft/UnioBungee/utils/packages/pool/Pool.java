package com.uniocraft.UnioBungee.utils.packages.pool;
...
import com.uniocraft.UnioBungee.utils.packages.pool.properties.HikariProperty;
...
public class Pool {
    ...
    public void build() {
        ...
        config.setPoolName("UnioBungeePool");
